...
import { FooterContainer, VolumeWrapper, SwitchWrapper, SwitchContainer } from 'src/common/styles/FooterStyle';
import CurrentTrack from '../CurrentTrack/CurrentTrack';
import MusicController from 'src/features/MusicController/MusicController';
